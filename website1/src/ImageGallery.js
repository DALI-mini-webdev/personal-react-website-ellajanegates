...
import ocho from './images/d5c7d0c7-ce78-404a-a9ff-91abd45d963d.JPG';
...
class ImageGallery extends React.Component {
    ...
    showMexico = () => {
      ...
      <div className="gallery">
        ...
        <div className="desc">A street near my house</div>
      </div>
    ...
    render() {
        return(
          <div>
            <button type="button" onClick={() => {this.handleClick}}> Colorado </button>            
            {(this.state.clicked ? this.showMexico : this.showColorado)}
          </div>
          );
    }
}
